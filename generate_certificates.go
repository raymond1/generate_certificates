...
//database and serialNumber are the file locations of the database and serial number files used
//for the configuration file used for the openssl ca command.
func hydrateTemplate(template, outputConfiguration, database, serialNumber string) {
	...
	newFileContents := fmt.Sprintf(contentsAsString, database, serialNumber)
